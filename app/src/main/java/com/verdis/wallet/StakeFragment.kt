...
class StakeFragment : Fragment() {
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (wallet != null) {
                    ...
                    val staked = (details?.staked ?: 0.0) 
                    tvYourStake.text = "${String.format("%.4f", staked)} VRDX"
                    tvRewards.text = "${String.format("%.4f", staked * 0.05)} VRDX" // 5% APY estimate
                }
            } catch (e: Exception) {
    ...
    class ValidatorAdapter(
        ...
        override fun onBindViewHolder(holder: VH, position: Int) {
            ...
            holder.stake.text = "${String.format("%.0f", v.totalRewards)} VRDX"

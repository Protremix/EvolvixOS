    ...
    private fun loadData() {
        lifecycleScope.launch {
            ...
            try {
                ...
                val balanceVrdx = balance 
                tvBalance.text = String.format("%.4f", balanceVrdx)

                val price = market?.priceUSD ?: 0.0
                tvBalanceUsd.text = "$${String.format("%.2f", balanceVrdx * price)}"
                ...
                tokens.add(TokenItem("VRDX", "Verdis", balanceVrdx, price))
